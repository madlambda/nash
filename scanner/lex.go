...
func lexStart(l *lexer) stateFn {
	...
	case r == '}':
		l.emit(token.BracesClose)
		return lexStart
	case r == '(':
		l.emit(token.ParenOpen)
		return lexInsideFnInv
	case r == ')':
		l.emit(token.ParenClose)
		return lexStart
	}
